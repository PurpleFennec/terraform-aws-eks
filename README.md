...
| <a name="input_cloudwatch_log_group_keep_on_delete"></a> [cloudwatch\_log\_group\_keep\_on\_delete](#input\_cloudwatch\_log\_group\_keep\_on\_delete) | Determines whether or not the log group is kept after cluster deletion | `bool` | `false` | no |
